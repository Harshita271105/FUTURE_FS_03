...
export default function BeautyPage() {
  const products = [
    ...
    { id: 2, name: "Matte Finish Lipstick", price: 699 },
    { id: 3, name: "Vitamin C Serum", price: 1299 },
    { id: 4, name: "Herbal Face Cleanser", price: 599 },
  ];

  return (
    <main className="min-h-screen bg-gray-50 px-6 md:px-10 py-10">
      <h1 className="text-4xl font-bold mb-3">Beauty Collection</h1>
      <p className="text-gray-600 mb-10">
        Skincare, makeup, and self-care essentials
      </p>
